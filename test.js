exports.run = (client, message, args) => {
  ...
  let panelTitle = "Panel Management";
  let serverTitle = "Server Management";
  let accountTitle = "Account Management";
  let footer = `Requested By ${message.author.username} - ${client.user.username}`;
  let footerIcon = message.author.avatarURL({ dynamic: true });
  let color = "E5BE11";
  let thumbnail = client.user.avatarURL();
  let image = "https://cdn.discordapp.com/attachments/1169979543885447279/1190102964946341888/cat.gif";
  const id = message.author.id;
  const usernames = message.author.username;
  ...
  const errorDB = new MessageEmbed()
    ...
    .setTitle(`${message.author.username} ${panelTitle}`)
  ...
  const closeEmbed = new MessageEmbed()
    .setDescription("Proccess Terminated")
    .setTitle(`${message.author.username} ${panelTitle}`)
    .setColor(color);
  ...
  panel
    ...
    .then((panels) => {
      ...
      const reEmbed = new MessageEmbed()
        .setColor(color)
        .setFooter(footer, footerIcon)
        .setThumbnail("https://cdn.discordapp.com/avatars/1037439874325819513/802bdae0def742c31c3b6ac86f163da6.png")
        .setImage(image
        );
      ...
      const reUrl = new MessageEmbed()
        ...
        .setColor(color)
        .setDescription(
          "Please send your panel url. Example: **(https://panel.example.com)**"
        );
      ...
      const reApi = new MessageEmbed()
        ...
        .setColor(color)
        .setDescription(
          "Please send your client api key. Get From Like https://panel.example.com/account/api"
        );
      ...
      const reMenu = new MessageMenuOption()
        .setLabel("Register New Panel")
        .setDescription("Register to a new panel")
        .setEmoji("📔")
        .setValue("register");

      const closeMenu = new MessageMenuOption()
        .setLabel("Close")
        .setDescription("Close Select Menu")
        .setEmoji("⛔")
        .setValue("close");
      ...
      panels.forEach((data) => {
        let option = new MessageMenuOption()
          .setLabel(data.NAME)
          .setDescription("Manage This Panel")
          .setEmoji("🏷️")
          .setValue(data.NAME);
      ...
      const panelEmbed = new MessageEmbed()
        ...
        .setImage(image)
        .setColor(color)
        .setDescription("Select a Panel to Manage\n\nPanel List:\n" + panelist);

      const panelMenu = new MessageMenu().addOptions(options).setID("pmenu");

      message.channel.send
        ({ embed: panelEmbed, component: panelMenu })
        .then((panelmsg) => {
          const filter = (button) =>
            button.clicker.user.id === message.author.id;
              ...
              panel
                ...
                .then((fpanel) => {
                  const panelManage = new MessageEmbed()
                    ...
                    .setColor(color)
                    .setDescription(
                      "Welcome To Terminal Servers Dashboard.\nCurrently Selected Panel: " + m.values[0]
                    );
                  ...
                  panelManageCollector.on("collect", async (pm) => {
                    ...
                    if (pm.id === "pAcc") {
                      ...
                      Client.getAccountDetails().then((acc) => {
                        ...
                        const newEmail = new MessageEmbed()
                          ...
                          .setColor(color)
                          .setDescription(
                            "Send your new password for this panel"
                          );
                        ...
                        const accEmbed = new MessageEmbed()
                          .setTitle(`${message.author.username} ${accountTitle}`)
                          .setFooter(footer, footerIcon)
                          .setColor(color)
                          .setThumbnail(thumbnail)
                          .setDescription(
                    ...
                    if (pm.id === "pEdit") {
                      ...
                      panelmsg.edit({ embed: embedEdit, component: editRows, ephemeral: true });
                    ...
                    if (pm.id === "pDelete") {
                      const pDelEmbed = new MessageEmbed()
                        ...
                        .setColor(color)
                        .setDescription(
                          "Panel succesfully deleted from the databases"
                        );
                    ...
                    if (pm.id === "pManage") {
                      ...
                      Client.getAllServers()
                        .then((response) => {
                          ...
                          serverEmbed.setTitle(`${message.author.username} ${serverTitle}`);
                          serverEmbed.setThumbnail(thumbnail);
                          serverEmbed.setFooter(footer, footerIcon);
                              ...
                              if (sm.values[0] === "close") {
                                ...
                                try {
                                  ...
                                  const sftpEmbed = new MessageEmbed()
                                    .setTitle(`${message.author.username} ${serverTitle}`)
                                    .setColor(color)
                                    .setFooter(footer, footerIcon)
                                    .setDescription(
                                      "SFTP Details:\n```\nServer Address: " +
                                  ...
                                  serverStart.setStyle("green");
                                  serverStart.setEmoji('🚀')
                                  ...
                                  let errNaN = new MessageEmbed()
                                    .setTitle(
                                      "Terminal Not a Pterodactyl Panel",
                                      client.user.avatarURL()
                                    )
                                    .setColor(color)
                                    .setDescription(
                        ...
                        .catch((e) => {
                          let ErrCon = new MessageEmbed()
                            .setTitle("Terminal Server Management")
                            .setThumbnail(client.user.avatarURL())
                            .setColor(color)
                            .setDescription(
                          ...
                          let err305 = new MessageEmbed()
                            .setTitle("Terminal Was Error 305")
                            .setColor(color)
                            .setDescription(
                              "An error occured while fetching your servers. This can occur if your host has cloudflare enabled on their panel which will prevent the bot from connecting to the endpoints"
                            )
                          ...
                          let err304 = new MessageEmbed()
                            .setTitle("Terminal Was Error 304")
                            .setColor(color)
                            .setDescription(
                              "An error occured while fetching your servers. This can occur if you put wrong apikeys, make sure the apikeys are client not admin"
                            )
                          ...
                          let err344 = new MessageEmbed()
                            .setTitle("Terminal Was Error 344")
                            .setColor(color)
                            .setDescription(
                              "An error occured while fetching your servers. This can occur if the panel is down"
                            )
